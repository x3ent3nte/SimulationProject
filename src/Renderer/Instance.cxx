...
namespace {
    ...
    bool checkValidationLayerSupport() {
        ...
        for (const char* layerName : Constants::kValidationLayers) {
...
VkInstance Instance::createInstance() {
    ...
    if (Constants::kEnableValidationLayers && !checkValidationLayerSupport()) {
        throw std::runtime_error("Validation layers requested, but not available");
    }

    VkApplicationInfo appInfo{};
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "Cosmosis";
...
void Instance::setupDebugMessenger(VkInstance instance, VkDebugUtilsMessengerEXT& debugMessenger) {
    if (!Constants::kEnableValidationLayers) { return; }
