...
namespace Constants {
    ...
    const std::string kSmallAsteroidModelPath = "models/small_asteroid.obj";
    ...
    const std::string kPlanetModelPath = "models/planet.obj";
    const std::string kPlanetTexturePath = "textures/planet_texture.png";
