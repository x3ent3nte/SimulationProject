...
void AgentSorter::mapAgentToX(float timeDelta) {
    ...
    Command::runAndWait(m_mapAgentToXCommandBuffer, m_fence, m_queue, m_logicalDevice);
}

void AgentSorter::mapXToAgent() {
    Command::runAndWait(m_mapXToAgentCommandBuffer, m_fence, m_queue, m_logicalDevice);
}
